...
<body <?php echo ($page != 'home') ? 'class="sub_page"' : ''; ?>>
  ...
  <div class="hero_area">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              <li class="nav-item <?php echo ($page == 'home') ? 'active' : ''; ?>">
                <a class="nav-link" href="index.php?act=/">Home <?php echo ($page == 'home') ? '<span class="sr-only">(current)</span>' : ''; ?></a>
              </li>
              <li class="nav-item <?php echo ($page == 'menu') ? 'active' : ''; ?>">
                <a class="nav-link" href="index.php?act=menu">Menu</a>
              </li>
              <li class="nav-item <?php echo ($page == 'about') ? 'active' : ''; ?>">
                <a class="nav-link" href="index.php?act=about">About <?php echo ($page == 'about') ? '<span class="sr-only">(current)</span>' : ''; ?></a>
              </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="#">
            Xin chào, <?php 
              $displayName = $_SESSION['user']['name'] ?? $_SESSION['user']['username'] ?? $_SESSION['user']['email'] ?? 'User';
...
<?php else: ?>
    <li class="nav-item <?php echo (isset($page) && $page === 'Login') ? 'active' : ''; ?>">
              ...
              <a class="cart_link" href="#">
                ...
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  ...
                  <g><g><path d="M345.6,338.862c-29.184,0-53.248,23.552-53.248,53.248
                      ...
                      C398.336,362.926,374.784,338.862,345.6,338.862z"/></g></g>
                  <g><g><path d="M439.296,84.91c-1.024,0-2.56-0.512-4.096-0.512H112.64
                      ...
                      c26.624,0,49.664-18.944,55.296-45.056l33.28-166.4C457.728,97.71,450.56,86.958,439.296,84.91z"/></g></g>
                  <g><g><path d="M215.04,389.55c-1.024-28.16-24.576-50.688-52.736-50.688
                      ...
                      C193.536,443.31,216.576,418.734,215.04,389.55z"/></g></g>
                </svg>
              </a>
